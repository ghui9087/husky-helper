...
const ApartmentCard = ({
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="relative h-40 sm:h-48 overflow-hidden bg-purple-medium">
        <img
          src={image}
          alt={name}
        ...
        <div className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3 right-2 sm:right-3">
          <span className="inline-flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-full bg-background/90 backdrop-blur-sm text-xs font-medium">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center gap-1 text-muted-foreground text-sm mb-2 sm:mb-3">
